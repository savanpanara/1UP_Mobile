...
- (void)viewDidLoad
{
    ...
    [txt_Name setValue:[UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:1.0] forKeyPath:@"_placeholderLabel.textColor"];
    ...
    if (textField.tag <= 3)
    {
        ...
        switch (textField.tag)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                [scrlView setContentOffset:CGPointMake(0, view_Name.center.y - 140) animated:YES];
...
-(void)handleSingleTapGestureToview:(UITapGestureRecognizer *)tapGestureRecognizer
{
    ...
    {
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Name Field is Empty" message:@"Please Enter Your Name" preferredStyle:UIAlertControllerStyleAlert];
